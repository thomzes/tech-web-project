<?php 
    ...
    if(isset($_POST['reset'])) {
        ...
        if(isset($_COOKIE['_uid_']) && isset($_COOKIE['_uiid_'])) { // SET COOKIE
            setcookie('_uid_', '', time() - 60 * 60 * 24, '/', '', '', true); // Create cookie with name = _uid_ and value null //dtk,mnt,jam,hari
            setcookie('_uiid_', '', time() - 60 * 60 * 24, '/', '', '', true); // Create cookie with name = _uid_ and value null //dtk,mnt,jam,hari
        }
