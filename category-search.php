            ...
            <div id="layoutDefault_content">
                <main>
                    ...
                    <nav class="navbar navbar-marketing navbar-expand-lg bg-white navbar-light">
                        <div class="container">
                            <a class="navbar-brand text-dark" href="index.php">Tech</a><button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><img src="img/menu.png" style="height:20px;width:25px" /><i data-feather="menu"></i></button>
                    ...
                    <?php 
                        if(isset($_POST['search-keyword'])) {
                            $url = "http://localhost/tech/category-search.php?key=".$_POST['search-keyword']."&cat_id=".$_POST['category-id'];
                            header("Location: {$url}");
                        }
                    ?>
                                ...
                                <?php 
                                    ...
                                    if($count == 0) {
                                        ...
                                        while($posts = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            $post_detail = substr($posts['post_details'], 0, 140); 
